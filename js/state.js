...
(function (global) {
  ...
  /* φ is undefined at the origin (ρ = 0). Remember the last
  ...
  if (isNaN(lastSph.phi)) lastSph = { theta: 0, phi: 0 };
  ...
  function applySection(section, v) {
    ...
    switch (section) {
      ...
      case 'sph': {
        ...
        const phi = C.clamp(v.phi, 0, Math.PI);
        pt = C.sphToCart(r, v.theta, phi);
        break;
      }
    }
